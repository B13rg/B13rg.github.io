...
Starting to serve on 127.0.0.1:8886
{
  ...
  "metadata": {
    ...
    "labels": {
      "argocd.argoproj.io/instance": "privatebin",
      "base_domain": "taiga.resolv.to",
      "kubernetes.io/metadata.name": "privatebin",
      "timezone": "US_LosAngles"
    },
    "annotations": {
      "kustomize.service": "privatebin",
      "kustomize.stack": "taiga"
    },
    "managedFields": [
      {
